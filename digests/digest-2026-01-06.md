# Engineering Daily Digest – 2026-01-06
...
### 1. Happy New Year! AWS Weekly Roundup: 10,000 AIdeas Competition, Amazon EC2, Amazon ECS Managed Instances and more (January 5, 2026)
...
### 2. AWS Weekly Roundup: Amazon ECS, Amazon CloudWatch, Amazon Cognito and more (December 15, 2025)
...
### 3. AWS Weekly Roundup: AWS re:Invent keynote recap, on-demand videos, and more (December 8, 2025)
...
### 3. WRAP up your backlog with GitHub Copilot coding agent

**URL:** https://github.blog/ai-and-ml/github-copilot/wrap-up-your-backlog-with-github-copilot-coding-agent/

**Published:** 2025-12-26 17:56

**Summary:**

An easy-to-remember acronym, WRAP will help you write effective issues, refine your instructions, and get the most out of Copilot coding agent The post WRAP up your backlog with GitHub Copilot coding agent appeared first on The GitHub Blog.


## Google Developers

### 1. 5 things to try with Gemini 3 Pro in Gemini CLI

**URL:** https://developers.googleblog.com/5-things-to-try-with-gemini-3-pro-in-gemini-cli/

**Published:** 2026-01-06 09:24
...
### 2. Building AI Agents with Google Gemini 3 and Open Source Frameworks
...
*Generated on 2026-01-06 09:24:48*