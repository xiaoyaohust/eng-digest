# Engineering Daily Digest – 2026-08-18
...
### 1. AWS Weekly Roundup: EC2 application status checks, IAM role manager, OpenAI Daybreak on Bedrock, and more (August 17, 2026)
...
### 2. AWS Weekly Roundup: AWS Heroes Summit, Web Search on Amazon Bedrock, Dogwood, Kiro Crew, and more (August 10, 2026)
...
### 3. Runtime instances: persistent compute for production AI agents on Amazon Bedrock AgentCore
...
### 1. New currency capabilities for global businesses to cut FX costs
...
### 3. Analyzing the evidence that helps businesses win “product not received” disputes
...
*Generated on 2026-08-18 09:29:19*