# Engineering Daily Digest – 2026-08-22
...
### 1. AWS Glue 6.0 now available with 30% lower price and full Apache Iceberg v3 support
...
### 2. In the works: AWS Builder Lofts in Berlin, Hyderabad, and São Paulo
...
### 3. AWS Weekly Roundup: EC2 application status checks, IAM role manager, OpenAI Daybreak on Bedrock, and more (August 17, 2026)
...
*Generated on 2026-08-22 09:23:12*