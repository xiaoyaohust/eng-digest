...
export const learningPaths: LearningPath[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      {
        id: "copilot-security-review",
        title: "Defend an enterprise Copilot design",
        description: "Practice explaining authorization, delegated tools, revocation, and failure trade-offs at Staff level.",
        href: "/system-design/secure-enterprise-copilot-api/",
        duration: 25,
        kind: "read",
      },
    ],
